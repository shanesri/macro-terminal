...
if st.session_state.tickers_list:
    ...
    with s_col2:
        # Added help tooltip for Horizon
    ...
    with s_col3:
        # Added help tooltip for Data Range
        lookback_years = st.selectbox("Data Range (Years)", [1, 3, 5, 10], index=1, help="We use this historical data to calculate asset correlations and volatility (the 'DNA') for the simulation.")
    with s_col4:
        # Added help tooltip for Initial Investment
