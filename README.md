...
| `portoptimize` | Page ⚖️ Weight Optimizer (Efficient Frontier) |
| `portmng` | Page 📈 Monte Carlo Simulator |
...
├── pages/
│   ├── 1_⚖️_Weight_Optimizer.py        # Efficient Frontier optimizer (MPT)
│   └── 2_📈_Monte_Carlo_Simulator.py   # Buy & Hold Monte Carlo simulation
├── requirements.txt
├── .devcontainer/
└── README.md
```
